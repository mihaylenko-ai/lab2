...
**Таблица соседства OSPF на коммутаторе S1**
...
**Таблица соседства OSPF на коммутаторе S2**
...
**Таблица соседства OSPF на коммутаторе L1**
...
**Таблица соседства OSPF на коммутаторе L2**
...
**Таблица соседства OSPF на коммутаторе L3**

![S1](images/neighbor_L3.jpg)

Как видно из результатов все коммутаторы установии устойчивое соседство, перейдя в состояние FULL. Так же все коммутаторы уровня Spine стали BR маршрутизаторами, а все коммутаторы
уровня Leaf соответственно BDR маршрутизаторами, что соответствует распределению их значениям router-id.
...
Был настроен протокол OSPF на рабочем стенде, собранного в соответствии с CLOS архитекрурой. Произведены испытания, показавшие наличие IP связности сетевых усторйств посредством
протокола OSPF между уровнями Spine и Leaf, а так же конечными устройствами.